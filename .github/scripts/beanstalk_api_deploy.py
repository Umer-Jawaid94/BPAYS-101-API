...
VERSION_LABEL = os.getenv('AWS_EB_VERSION')
BUCKET_KEY = os.getenv('APPLICATION_NAME') + '/' + \
    os.getenv('DEPLOYMENT_PACKAGE_NAME') + '.zip'
...
def create_new_version():
    ...
    try:
        response = client.create_application_version(
            ...
            Description='Build Deployed from Github Actions',
            SourceBundle={
